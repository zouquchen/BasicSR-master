...
def generate_meta_info_div2k():
    ...
    gt_folder = 'D:/zqc2/2-dataset/LDL-datasets/DIV2K/DIV2K_train_HR_sub/'
    meta_info_txt = 'D:/zqc2/2-dataset/LDL-datasets/DIV2K/meta_info/meta_info_DIV2K800sub_GT.txt'
